...
//
// $Header: /cvs/myengine/src_main/tier0/dbg.cpp,v 1.1 2008/02/28 14:32:38 easap\albertyang Exp $
// $NoKeywords: $
//
...
SpewRetval_t  _SpewMessage( SpewType_t spewType, char const* pMsgFormat, va_list args )
{
	...
	assert( len < sizeof(pTempBuffer) ); /* use normal assert here; to avoid recursion. */
