...
//
// $Header: /cvs/myengine/src_main/public/valve/recording.h,v 1.1 2008/02/29 00:05:45 easap\albertyang Exp $
// $NoKeywords: $
//
...
DLL_EXPORT void RecordArgumentEx(const char* str, ...);
...
#	define RECORD_STRING_EX( ... )				RecordArgumentEx( ... )
...
#	define RECORD_DEBUG_STRING( _str )			0
#	define RECORD_STRING_EX( _string )			0
